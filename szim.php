...
<html>
	...
	<body>
		<div id="Container">
			<header>
				<div>
					<span id="title">FCMDev.hu</span>
				</div>
				<nav>
					<a class="nav-link" id="kezdolap" href="kezdolap.php">Vissza a kezdőlapra</a>
		...
		<div id="container-login100" class="container-login100">
			<div class="row" style="margin: 0px">
				<h1 class="col-lg-11 col-md-11 col-sm-12 text-center">FCM létrehozása</h1>
				<h2 class="col-lg-1 col-md-1 col-sm-12 col-xs-12 d-flex justify-content-sm-center d-flex justify-content-center">
					<button class="kijelentkezes" onclick="window.location = 'logout.php'" style="float: right">Kijelentkezés</button>
				</h2>
			</div>
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 text-center">
					<button id="uj" onclick="ujrakezd()" style="display: none">Új FCM megadása</button>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 text-center">
					<button id="mentes" onclick="mentes()" style="display: none">Adatok mentése fájlba</button>
				</div>
			</div>
        </div>
		<script>
			...
			body1.appendChild(diveredmeny);
            //body reference 
            var body = document.getElementsByTagName("body")[0];
            body1.appendChild(details);
